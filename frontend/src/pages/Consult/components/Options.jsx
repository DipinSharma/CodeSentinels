...
import { BiClipboard, BiPhoneOff } from "react-icons/bi";
...
const Options = () => {
    ...
    useEffect(() => {
        // Check if the current path is '/videoChat'
        if (location.pathname === '/videoChat' && userType !== "doctor") {
            // Call user with the current idToCall
            // if (idToCall) {
                callUser(); // Pass idToCall to callUser function
            // }
        }
    }, [location.pathname, userType, callUser]); // Add dependencies
                    ...
                    <Grid templateColumns='repeat(2, 1fr)' mt="12">
                        <Grid colSpan={1} p="6">
                            ...
                            <CopyToClipboard text={me}>
                                <Button leftIcon={<BiClipboard />} colorScheme='teal' variant='solid' mt="4">
                                    Copy ID
                                </Button>
                            </CopyToClipboard>
                        </Grid>
